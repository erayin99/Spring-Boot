...
findById(id).orElseThrow(() ->new NotFoundException("Not Found Exception"));
	...
	(new User(userCreateDTO.getUserName(),userCreateDTO.getFirstName(), 
	...
	public List<UserViewDTO> getUsers() {
		...
		.map(UserViewDTO::of).collect(Collectors.toList());
	}
